...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        help="Embedding dimension in the 2 blocks of zipformer encoder layers, "
        "comma separated",
    )
    ...
    parser.add_argument(
        ...
        help="Unmasked dimensions in the encoders, "
        "relates to augmentation during training.  "
        "Must be <= each of encoder_dims.  Empirically, "
...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=float,
        default=3.5,
        help="""Number of epochs that affects how rapidly the 
