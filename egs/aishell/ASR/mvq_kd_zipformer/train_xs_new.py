...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        # default="192,192,192,256,192,192",
        # default="128,128,128,192,128,128",
    ...
    parser.add_argument(
        ...
        # default="128,192,192,192,192,192",
        # default="96,128,128,128,128,128",
...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="If True, use distill early stop.",
    )
...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    ...
    # encoder = Zipformer2(**encoder_args)
    return encoder
...
def get_model(params: AttributeDict) -> nn.Module:
    ...
    model = AsrModel(
        ...
        encoder_dim=max(int(x) for x in params.encoder_dim.split(",")),
        decoder_dim=params.decoder_dim,
        vocab_size=params.vocab_size,
...
def run(rank, world_size, args):
    ...
    #         new_optimizer_state = OrderedDict()
    #         for key, value in optimizer_state['state'].items():
    #             if 'awl' not in key and 'codebook_loss_nets' not in key:
    #                 new_optimizer_state[key] = value
    #         filtered_state_dict = {'state': new_optimizer_state,
    #                                                     'param_groups': [group for group in optimizer_state['param_groups'] if 'awl' not in group and 'codebook_loss_nets' not in group]}
    #         optimizer_state = filtered_state_dict
