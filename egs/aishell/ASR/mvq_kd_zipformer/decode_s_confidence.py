...
# from train_xs import add_model_arguments, get_model, get_params
...
def decode_one_batch(
    ...
    encoder_out, encoder_out_lens, outputs = model.encoder(x, x_lens, src_key_padding_mask)
...
def main():
    ...
    test_cuts = aishell.train_multilayer_distill_cuts()
