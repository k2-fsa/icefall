...
if [ $stage -le 3 ] && [ $stop_stage -ge 3 ]; then
    ...
    python3 local/normalize_eval2000.py data/manifests/eval2000/supervisions_unnorm_eval2000.jsonl data/manifests/eval2000/supervisions_eval2000.jsonl
    lhotse fix data/manifests/eval2000/recordings_eval2000.jsonl data/manifests/eval2000/supervisions_eval2000.jsonl data/manifests
