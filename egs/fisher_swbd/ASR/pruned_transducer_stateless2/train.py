...
def run(rank, world_size, args):
    ...
    train_dl = fisherswbd.train_dataloaders(
        train_cuts, sampler_state_dict=sampler_state_dict
    )

    valid_cuts = fisherswbd.dev_fisher_cuts()
    valid_cuts += fisherswbd.dev_swbd_cuts()
    valid_dl = fisherswbd.valid_dataloaders(valid_cuts)
