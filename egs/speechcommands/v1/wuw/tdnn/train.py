...
def get_params() -> AttributeDict:
    ...
    Explanation of options saved in `params`:
        ...
        - wakeup_words:  Texts of wakeup words, i.e. positive samples.
        - wakeup_word_tokens: A sequence of token ids corresponding wakeup_words/.
...
def compute_loss(
    ...
    info["loss"] = loss.detach().cpu().item() * N
...
def run(rank, world_size, args):
    ...
    himia = SpeechCommands1DataModule(args)
