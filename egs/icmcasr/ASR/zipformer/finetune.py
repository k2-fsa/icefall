...
./zipformer/finetune.py \
  ...
  --pretrained-ckpt  /raid/wend/asr/icmc/multi_zh/icefall-asr-multi-zh-hans-zipformer-ctc-2023-10-24/exp/epoch-20.pt \
  --use-ctc 1
...
def run(rank, world_size, args):
    ...
    train_cuts = icmc.train_all_cuts()
    ...
    def remove_short_utt_dev(c: Cut):
        # In pruned RNN-T, we require that T >= S
        # where T is the number of feature frames after subsampling
        # and S is the number of tokens in the utterance
    ...
    valid_cuts = valid_cuts.filter(remove_short_utt_dev)
