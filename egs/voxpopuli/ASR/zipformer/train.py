...
def get_parser():
    ...
    parser.add_argument(
        "--bpe-model",
        type=str,
        default="data/lang_bpe_500_es/bpe.model",
...
def run(rank, world_size, args):
    ...
    if not args.use_validated_set:
        ...
        train_cuts = voxpopuli.validated_cuts()

    if args.use_invalidated_set:
        train_cuts += voxpopuli.invalidated_cuts()
    ...
    train_dl = voxpopuli.train_dataloaders(
        train_cuts, sampler_state_dict=sampler_state_dict
    )

    dev_cuts = voxpopuli.dev_cuts()
    dev_dl = voxpopuli.valid_dataloaders(dev_cuts)
