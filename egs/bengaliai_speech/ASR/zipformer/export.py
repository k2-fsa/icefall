...
Note: This is a example for bengaliai_speech dataset, if you are using different
...
you can do:
    ...
    cd /path/to/egs/bengaliai_speech/ASR
    ./zipformer/decode.py \
        --exp-dir ./zipformer/exp \
        --epoch 9999 \
        --avg 1 \
...
- non-streaming model:
https://huggingface.co/Zengwei/icefall-asr-bengaliai_speech-zipformer-2023-05-15

- streaming model:
https://huggingface.co/Zengwei/icefall-asr-bengaliai_speech-streaming-zipformer-2023-05-17

with the following commands:

    sudo apt-get install git-lfs
    git lfs install
    git clone https://huggingface.co/Zengwei/icefall-asr-bengaliai_speech-zipformer-2023-05-15
    git clone https://huggingface.co/Zengwei/icefall-asr-bengaliai_speech-streaming-zipformer-2023-05-17
