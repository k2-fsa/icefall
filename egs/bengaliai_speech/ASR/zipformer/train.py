...
def run(rank, world_size, args):
    ...
    train_cuts = bengaliai_speech.train_cuts()
    ...
    train_dl = bengaliai_speech.train_dataloaders(
        train_cuts, sampler_state_dict=sampler_state_dict
    )

    valid_cuts = bengaliai_speech.valid_cuts()
    valid_dl = bengaliai_speech.valid_dataloaders(valid_cuts)
