...
from asr_datamodule import BengaliAISpeechAsrDataModule
...
def main():
    parser = get_parser()
    BengaliAISpeechAsrDataModule.add_arguments(parser)
    ...
    bengaliai_speech = BengaliAISpeechAsrDataModule(args)

    test_clean_cuts = bengaliai_speech.test_clean_cuts()
    test_other_cuts = bengaliai_speech.test_other_cuts()

    test_clean_dl = bengaliai_speech.test_dataloaders(test_clean_cuts)
    test_other_dl = bengaliai_speech.test_dataloaders(test_other_cuts)
