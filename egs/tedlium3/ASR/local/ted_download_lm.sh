...
wget --continue http://kaldi-asr.org/models/5/4gram_small.arpa.gz -P data/lm/ || exit 1
wget --continue http://kaldi-asr.org/models/5/4gram_big.arpa.gz -P data/lm/ || exit 1
