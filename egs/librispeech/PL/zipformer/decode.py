...
from train_pl import add_model_arguments, get_model, get_params
...
def main():
    ...
    if params.dataset == "tedlium":
        dev_cuts = librispeech.dev_tedlium_cuts()
        test_cuts = librispeech.test_tedlium_cuts()

        dev_dl = librispeech.test_dataloaders(dev_cuts)
        test_dl = librispeech.test_dataloaders(test_cuts)

        test_sets = ["dev-tedlium", "test-tedlium"]
