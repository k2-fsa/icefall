...
from asr_datamodule_ubiqus import UbiqusAsrDataModule
...
def load_checkpoint_if_available(
    ...
    if params.start_batch > 0:
        ...
        return None
    filename = params.exp_dir / f"checkpoint-2632000.pt"
...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        simple_loss, pruned_loss, loss_lm = model(
            x=feature,
            x_lens=feature_lens,
            y=y,
        ...
        loss = params.simple_loss_scale * simple_loss + pruned_loss + 0.5*loss_lm
    ...
    info["lm_adapt_loss"] = loss_lm.detach().cpu().item()
...
def train_one_epoch(
    ...
    def maybe_log_param_relative_changes():
        ...
        elif params.batch_idx_train % 5 == 1:
            optimizer.step()
            optimizer.zero_grad()
