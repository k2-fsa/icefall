...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--feedforward-dim",
        type=str,
        default="512,1024,1536,2048,3072,2048,1536,1024,512",
    ...
    parser.add_argument(
        "--encoder-dim",
        type=str,
        default="192,256,384,512,768,512,384,256,192",
...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    encoder = Mixformer(
        ...
        pos_dim=_to_int_tuple(params.pos_dim),
...
def run(rank, world_size, args):
    ...
    scheduler = Eden(optimizer, params.lr_batches, params.lr_epochs, warmup_batches=params.warmup_batches, warmup_start=params.warmup_start)
