...
Usage:
(1) ctc-decoding
./conv_emformer_transducer_stateless2_ctc/ctc_decode.py \
    --epoch 30 \
    --avg 15 \
    --exp-dir ./conv_emformer_transducer_stateless2_ctc/exp \
    --max-duration 600 \
...
def get_parser():
    ...
    parser.add_argument(
        "--exp-dir",
        type=str,
        default="conv_emformer_transducer_stateless2_ctc/exp",
