...
class Conformer(EncoderInterface):
    ...
    Args:
        ...
        knowledge_M: softmax size in knowledge base
        knowledge_N: number of softmaxes in knowledge base
        knowledge_D: feature dimension in knowledge base
        knowledge_K: number of samples to use each time in knowledge base
        knowledge_share: number of successive layers that share the same knowledge
               base
    """
    def __init__(
        self,
        ...
        num_knowledge_bases = (num_encoder_layers + knowledge_share - 1) // knowledge_share # round up
        self.knowledge_base = nn.ParameterList([ create_knowledge_base(knowledge_M, knowledge_N,
                                                                    knowledge_D)
                                              for _ in range(num_knowledge_bases) ])
        ...
        encoder_layers = [ ConformerEncoderLayer(
            self.knowledge_base[n // knowledge_share],
            d_model,
            nhead,
            dim_feedforward,
            dropout,
...
class ConformerEncoder(nn.Module):
    ...
    Args:
        encoder_layers: the list of ConformerEncoderLayer modules.
    ...
    def __init__(self, encoder_layers: List[nn.Module]) -> None:
        super().__init__()
