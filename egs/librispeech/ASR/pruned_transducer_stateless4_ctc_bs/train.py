...
./pruned_transducer_stateless4_ctc_bs_withoutlconv/train.py \
  --world-size 4 \
  --num-epochs 40 \
  --start-epoch 1 \
  --exp-dir pruned_transducer_stateless4_ctc_bs_withoutlconv/exp_960 \
  --full-libri 1 \
  --max-duration 300
...
def get_parser():
    ...
    parser.add_argument(
        "--exp-dir",
        type=str,
        default="pruned_transducer_stateless4_ctc_bs_withoutlconv/exp",
...
def get_params() -> AttributeDict:
    ...
    Explanation of options saved in `params`:
        ...
        - model_warm_step: The warm_step for Noam optimizer.

        - ctc_warm_step: The warm_step for blank skip.
    """
