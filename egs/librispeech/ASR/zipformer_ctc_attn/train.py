...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=int,
        default=384,
        help="Embedding dimension of attention decoder. "
        "It should be equal to encoder_dims[-1].",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=256,
        help="Unmasked dimension in the attention decoder, relates to augmentation during training.  "
        "Must be <= each of decoder_dim.  Empirically, less than 256 seems to make performance "
        " worse.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=192,
        help="Attention dimension in attention decoder.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=8,
        help="Number of attention heads in attention decoder.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2048,
        help="Feedforward dimension in attention decoder.",
    )
    ...
    params = AttributeDict(
        {
            ...
            # parameters for attention decoder loss
            "ignore_id": -1,
            "label_smoothing": 0.1,
            "warm_step": 2000,
...
def get_decoder_model(params: AttributeDict) -> nn.Module:
    ...
    assert params.decoder_dim == encoder_dim, (params.decoder_dim, encoder_dim)

    decoder = AttentionDecoderModel(
        vocab_size=params.vocab_size,
        decoder_dim=params.decoder_dim,
        unmasked_dim=params.decoder_unmasked_dim,
...
def run(rank, world_size, args):
    ...
    def remove_short_and_long_utt(c: Cut):
        ...
        tokens = graph_compiler.sp.encode(c.supervisions[0].text, out_type=str)
