...
from asr_datamodule_sbc import SBCAsrDataModule
...
def main():
    parser = get_parser()
    SBCAsrDataModule.add_arguments(parser)
    ...
    import os
    logging.info(f"os.environ['CUDA_VISIBLE_DEVICES'] = {os.environ['CUDA_VISIBLE_DEVICES']}")
    device = torch.device("cpu")
    if torch.cuda.is_available():
        device = torch.device("cuda", params.cuda_id)
    ...
    sbc = SBCAsrDataModule(args)

    test_cuts = sbc.test_cuts(
        # cuts_file="/exp/rhuang/meta/audio_ruizhe/santa-barbara-corpus/data/sbc_cuts.jsonl.gz",
        # cuts_file="/exp/rhuang/meta/audio_ruizhe/santa-barbara-corpus/data/sbc_cuts_original_supervisions.jsonl.gz",
        # cuts_file="/exp/rhuang/meta/audio_ruizhe/santa-barbara-corpus/data/sbc_cuts_15s.jsonl.gz",
        # cuts_file="/exp/rhuang/meta/audio_ruizhe/santa-barbara-corpus/data/sbc_cuts_30s.jsonl.gz",
        # cuts_file="/exp/rhuang/meta/audio_ruizhe/santa-barbara-corpus/data/sbc_cuts_45s.jsonl.gz",
        cuts_file="/exp/rhuang/meta/audio_ruizhe/santa-barbara-corpus/data/sbc_cuts_30s_multi_speaker.jsonl.gz",
    )
    test_dl = sbc.test_dataloaders(test_cuts)
