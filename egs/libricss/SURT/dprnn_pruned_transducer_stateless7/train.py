...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="""The encoder checkpoint to initialize the encoder (recognition module).
        If not specified, the encoder is randomly initialized.
        """,
    )
...
def train_one_epoch(
    ...
    while True:
        ...
        # If we are in warmup stage, get the batch from the 2spk dataset.
        if (
