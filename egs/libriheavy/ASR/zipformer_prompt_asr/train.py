...
from dataset import triplet_text_sampling, naive_triplet_text_sampling, random_shuffle_subset, joint_triplet_text_sampling
...
def get_first(texts: List[str], pre_texts: List[str]) -> str:
    # Always get the first one, which is the gt (mixed-cased trans)
    out = {
        "text": texts[0],
