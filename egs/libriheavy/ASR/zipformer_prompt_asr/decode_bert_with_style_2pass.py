...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Use the decoded text as pre-text in a 2-pass decoding",
    )
...
def save_results_with_normalization(
    params: AttributeDict,
    test_set_name: str,
    results_dict: Dict,
):
    # Save the un-normalized output
    save_results(
        params=params,
