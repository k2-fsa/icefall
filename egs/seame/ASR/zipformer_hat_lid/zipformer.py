...
class Zipformer2(EncoderInterface):
    ...
    def __init__(
        ...
        lid_output_layer: Optional[int] = None,
        pos_emb_skip_rate: FloatLike = ScheduledFloat(
            (0.0, 0.0), (4000.0, 0.0), default=0
        ),
    ) -> None:
        ...
        self.lid_output_layer = lid_output_layer
    ...
    def forward(
        ...
        if self.lid_output_layer is None:
            return x, lengths
        else:
            return x, lengths, outputs[self.lid_output_layer]
