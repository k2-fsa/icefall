...
def main():
    ...
    disc_tts = DiscTTSAsrDataModule(args)

    test_dac_cuts = disc_tts.test_dac_cuts()
    test_encodec_cuts = disc_tts.test_encodec_cuts()
    test_gt_cuts = disc_tts.test_gt_cuts()
    test_hifigan_cuts = disc_tts.test_hifigan_cuts()
    test_hubert_cuts = disc_tts.test_hubert_cuts()
    test_vq_cuts = disc_tts.test_vq_cuts()
    test_wavlm_cuts = disc_tts.test_wavlm_cuts()

    test_dac_dl = disc_tts.test_dataloaders(test_dac_cuts)
    test_encodec_dl = disc_tts.test_dataloaders(test_encodec_cuts)
    test_gt_dl = disc_tts.test_dataloaders(test_gt_cuts)
    test_hifigan_dl = disc_tts.test_dataloaders(test_hifigan_cuts)
    test_hubert_dl = disc_tts.test_dataloaders(test_hubert_cuts)
    test_vq_dl = disc_tts.test_dataloaders(test_vq_cuts)
    test_wavlm_dl = disc_tts.test_dataloaders(test_wavlm_cuts)
