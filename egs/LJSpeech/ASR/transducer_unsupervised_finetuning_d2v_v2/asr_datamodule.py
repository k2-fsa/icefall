...
class LJSpeechAsrDataModule:
    ...
    def dev_cuts(self) -> CutSet:
        logging.info("About to get LJSpeech dev cuts")
        
        return load_manifest_lazy(
            self.args.manifest_dir / "LJSpeech_cuts_dev.jsonl.gz"
        )

    @lru_cache()
    def test_cuts(self) -> CutSet:
        logging.info("About to get LJSpeech test cuts")
