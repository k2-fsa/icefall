...
class GigaSpeechAsrDataModule:
    ...
    def train_cuts(self) -> CutSet:
        ...
        return load_manifest_lazy(self.args.manifest_dir / "gigaspeech_cuts_M.jsonl.gz")

    @lru_cache()
    def dev_cuts(self) -> CutSet:
        logging.info("About to get dev cuts")
        cuts_valid = load_manifest_lazy(self.args.manifest_dir / "gigaspeech_cuts_DEV.jsonl.gz")
