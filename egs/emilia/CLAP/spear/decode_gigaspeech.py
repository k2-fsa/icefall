...
def main():
    ...
    params.res_dir = params.exp_dir / f"{params.decoding_method}-giga"
    ...
    gigaspeech_dev_cuts = gigaspeech_dev_cuts.map(partial(_add_task_id, 1))
    gigaspeech_test_cuts = librispeech.gigaspeech_test_cuts()
    gigaspeech_test_cuts = gigaspeech_test_cuts.map(partial(_add_task_id, 1))
