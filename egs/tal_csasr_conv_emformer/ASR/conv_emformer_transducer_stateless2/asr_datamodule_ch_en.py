...
class TAL_CSASRAsrDataModule:
    ...
    def train_dataloaders(
        ...
        logging.info("create train dataset finish")
        ...
        if self.args.bucketing_sampler:
            logging.info("Using DynamicBucketingSampler. num-buckets {}".format(self.args.num_buckets))
            train_sampler = DynamicBucketingSampler(
                cuts_train,
                max_duration=self.args.max_duration,
                shuffle=self.args.shuffle,
                num_buckets=self.args.num_buckets,
                num_cuts_for_bins_estimate=1000, #20000,
        ...
        logging.info("create train dataloader finish")
