...
def train_one_epoch(
    ...
    for batch_idx, batch in enumerate(train_dl):
        ...
        try:
            ...
            #logging.info('tot_loss params 0 {} {} {} {}'.format(loss,tot_loss,params.reset_interval,params.batch_idx_train)) ##
...
def run(rank, world_size, args):
    ...
    bpemb_en.spm = sentencepiece_load(params.lang_dir+'/spm_model_name.model')
    ...
    logging.info("Loading train_cuts")
    #tal_csasr = AishellAsrDataModule(args)
    ...
    for epoch in range(params.start_epoch, params.num_epochs + 1):
        logging.info('Epoch {} TRAIN info'.format(epoch))
